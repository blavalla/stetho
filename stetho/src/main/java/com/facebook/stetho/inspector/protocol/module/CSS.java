...
public class CSS implements ChromeDevtoolsDomain {
  ...
  public JsonRpcResult getMatchedStylesForNode(JsonRpcPeer peer, JSONObject params) {
    ...
    List<RuleMatch> matchedCSSRules = new ArrayList<>();
    matchedCSSRules.add(match);
    matchedCSSRules.add(accessibilityMatch);

    result.matchedCSSRules = ListUtil.copyToImmutableList(matchedCSSRules);
    ...
    mDocument.postAndWait(new Runnable() {
      ...
      public void run() {
        ...
        mDocument.getElementAccessibilityNodeInfo(
            elementForNodeId,
            new StyleAccumulator() {
              @Override
              public void store(String name, String value, boolean isDefault) {
